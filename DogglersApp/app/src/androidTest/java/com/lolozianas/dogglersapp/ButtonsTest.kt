...
class ButtonsTest {
    ...
    @Test
    fun clicking_vertical_button_list_displays_vertical_list() {
        onView(withId(R.id.btn_vertical)).perform(click())
        onView(withId(R.id.rv_vertical)).check(matches(isDisplayed()))
    }

    @Test
    fun clicking_horizontal_button_list_displays_horizontal_list() {
        onView(withId(R.id.btn_horizontal)).perform(click())
        onView(withId(R.id.rv_horizontal)).check(matches(isDisplayed()))
    }

    @Test
    fun clicking_grid_button_list_displays_grid_list() {
        onView(withId(R.id.btn_grid)).perform(click())
        onView(withId(R.id.rv_grid)).check(matches(isDisplayed()))
    }
}